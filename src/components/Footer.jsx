  ...
  render() {
    return (
      <footer className="footer-container">
        ...
        <div className="footer-container__content d-flex justify-content-center justify-content-lg-between justify-content-xl-between justify-content-sm-center justify-content-md-center row m-0 flex-column flex-sm-column flex-md-column flex-lg-row">
          ...
          <div className="footer-container__content--second-column d-flex flex-column">
            <h5 className="second-column-title">
              Popular Compares{' '}
              <span className="footer-line d-inline-block bg-white ml-1 mb-1"></span>
            </h5>
            <div
              onClick={() =>
                this.handleClick(
          ...
          <div className="footer-container__content--second-column d-flex flex-column">
            ...
            <h5 className="second-column-title mt-2">
              {'Follow Us'}{' '}
              <span className="footer-line d-inline-block bg-white ml-1 mb-1"></span>
            </h5>
            <div className="icons">
