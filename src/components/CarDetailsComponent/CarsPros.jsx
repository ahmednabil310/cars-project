	...
	render() {
		return (
			<div className="cars-pros-container">
				<div className="row">
					<div className="col-lg-4 col-md-12 pl-0 padding-mobile">
						<div className="car-pros">
					...
					<div className="col-lg-4 col-md-12 padding-mobile">
					...
					<div className="col-lg-4 col-md-12 pr-0 padding-mobile">
						<div className="car-cons">
							<div className="d-flex align-items-center title-container">
								<h3 className="cons">
