      ...
      <div className="row">
        <div className="col-lg-4 col-md-12 car-pros">
          ...
          <div className="pros-content pt-4">
            ...
            <h2>{t("Costs less than comparable luxury sedans in its class")}</h2>
          </div>
        ...
        <div className="col-lg-4 col-md-12 car-cons">
          ...
          <div className="pros-content pt-4">
            ...
            <h2>
              {t("Ride quality isn’t as cushy or refined as that of some rival sedans")}
            </h2>
          </div>
          <div className="pros-content">
            <img src={close} className="pr-4" />
        ...
        <div className="col-lg-4 col-md-12 car-cons">
          ...
          <div className="pros-content pt-4">
            ...
            <h2>
              {t("New blind-spot collision-avoidance assist helps with lane changes")}
            </h2>
          </div>
          <div className="pros-content">
            <img src={magic} className="pr-4" />
            <h2>
              {t("Optional 9.2-inch infotainment system now has customizable home screen")}
            </h2>
          </div>
        </div>
      </div>
