...
class CarCard extends Component {
  ...
  render() {
    ...
    const resale_Value = 'Resale Value';
    const nhtsA_Driver_Frontal_Rating = 'nhtsA Driver Frontal Rating';
    const euroNCAP_Overall_Adult_Rating = 'euroNCAP Overall Adult Rating';
