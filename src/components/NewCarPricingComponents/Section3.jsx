...
function Section3() {
  return (
    <div className="NewCarPricing-Section3 m-auto">
      <div className="NewCarPricing-Section2-Heading">
        ...
        <h3 className="NewCarPricing-Section2-Heading__h3">cars by category</h3>
      </div>
      <div className="row m-0">
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
        ...
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car4} alt="Truck" />
          <p>Trucks</p>
        </div>
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car7} alt="Luxury" />
          <p>Luxury</p>
        </div>
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car2} alt="Hatchback" />
          <p>Hatchbacks</p>
        </div>
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
        ...
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car3} alt="Hybrid" />
          <p>Hybrids</p>
        </div>
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car1} alt="Electric Car" />
          <p>Electric Cars</p>
        </div>
        <div className="NewCarPricing-Section3-CategoryContainer d-flex flex-column align-items-center col-xl-2 col-lg-4 col-sm-6 p-0">
          <img src={Car4} alt="Convertible" />
          <p>Convertibles</p>
        </div>
      </div>
    </div>
