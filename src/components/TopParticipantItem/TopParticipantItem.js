...
const TopParticipantItem = ({
	...
	return (
		<div className="TopParticipantItem d-flex align-items-center col-10 col-sm-6 col-md-4 col-lg-3 col-xl-2 mx-2 my-2">
			<div className="row w-100">
				...
				<div className="col-7 col-lg-7 col-xl-6 d-flex justify-content-start align-items-center p-0">
