...
class ReviewPortalComp extends Component {
  ...
  componentWillReceiveProps(nextState, prevState) {
    if (nextState.listReviews.length > 0 && nextState.ListCarsRate.length > 0 && nextState.ListLike.length > 0 &&
      nextState.ListParticipants.length > 0 && nextState.ListCarLike.length > 0) {
      this.setState({
        isloading: false
      });
    }
      ...
      <>
        {
          this.state.isloading ? <Loading />
            ...
            <>
              ...
              <div className="row m-0 paddingSchema">
                <div className="col-12 col-sm-12 col-md-12 col-lg-8  pl-0 pr-5">
                  <MostLikeReview />
                </div>
