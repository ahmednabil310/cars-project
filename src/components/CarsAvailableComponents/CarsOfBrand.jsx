...
class CarsOfBrand extends Component {
    ...
    fetchCarsDetails(){
       ...
       this.setState({CarsDetails:
               [
                   {title:'car1',img:'https://s3.caradvice.com.au/wp-content/uploads/2015/12/2016-Lexus-GS200t_10.jpg' },
                   {title:'car1',img:'https://s3.caradvice.com.au/wp-content/uploads/2015/12/2016-Lexus-GS200t_10.jpg' },
                   {title:'car1',img:'https://s3.caradvice.com.au/wp-content/uploads/2015/12/2016-Lexus-GS200t_10.jpg' },
                   {title:'car1',img:'https://s3.caradvice.com.au/wp-content/uploads/2015/12/2016-Lexus-GS200t_10.jpg' },
                   {title:'car1',img:'https://s3.caradvice.com.au/wp-content/uploads/2015/12/2016-Lexus-GS200t_10.jpg' }
                    ...
                    this.state.CarsDetails.map((item)=>{
                        return(
                            <div className='Cars-Available__container__carImgContainer col-12 col-sm-6 col-md-4 col-lg-4 p-0'>
                                ...
                                <div className='Cars-Available__container__carImgContainer__title'>{item.title}</div>
                            </div>
                        )
                    })
                }
